...
export function countryOptions(language: string): Array<{ value: CountryCode; label: string }> {
...
export function defaultCountryForLanguage(language: string): CountryCode {
  const defaults: Record<string, CountryCode> = {
    ar: 'AE',
    de: 'DE',
    en: 'CA',
    es: 'MX',
